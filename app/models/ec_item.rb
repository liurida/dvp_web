class EcItem < ActiveRecord::Base
  ...
  belongs_to :study
  belongs_to :dvp
  attr_accessible :author, :compiled_status, :creation_ts, :restriction,:description, :message, :modification_ts, :modified_by, :name, :proc_name, :reviewer, :tested_status,:study_id,:dvp_id
